...
<head>
    ...
    <meta name="description" content="Omnifood is a premium food delivery service with the mission to bring delicious and healthy meals to as many people as possible.">
...
<body>
    <header>
        ...
        <div class="hero-text-box">
            <h1>Goodbye junk food.
                <br> Hello super healty meals.</h1>
    ...
    <section class="section-meals">
        <h2 class="hidden-meals-header">Meals section</h2>
        <ul class="meals-showcase clearfix">
            ...
            <li>
                <figure class="meal-photo">
                    <img src="assets/img/2.jpg" alt="Simple pizza with cherry tomatoes">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
                    <img src="assets/img/3.jpg" alt="Chicken breats with vegetables">
                </figure>
            </li>
            <li>
                <figure class="meal-photo">
    ...
    <section class="section-steps" id="works">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="assets/img/app-iPhone.png" alt="Omnifood app on iPhone" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
                ...
                <div class="works-step clearfix">
                    <div>3</div>
                    <p>Enjoy your meal within 20 minutes. See you next time!</p>
                </div>

                <a href="#" class="btn-app">
                    <img src="assets/img/download-app.svg" alt="App Store Button">
                </a>
                <a href="#" class="btn-app">
                    <img src="assets/img/download-app-android.svg" alt="Play Store Button">
                </a>
            </div>
        </div>
    </section>
        ...
        <div class="row">
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    Now that I've gotten used to it, I couldn't live without my daily meals!
                    <cite>
                        <img src="assets/img/customer-1.jpg" alt="customer-1">Alberto Duncan</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="assets/img/customer-2.jpg" alt="customer-2">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite>
                        <img src="assets/img/customer-3.jpg" alt="customer-3">Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box js--wp-4">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>1 meal every day
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Order 24/7
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Access to newest creations
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Free delivery
                            </li>
                        </ul>
                    </div>
                    <div>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>1 meal 10 days/month
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Order 24/7
                            </li>
            ...
            <div class="col span-1-of-3">
                <div class="plan-box">
                    ...
                    <div>
                        <ul>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>1 meal
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Order from 8 am to 12 pm
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="close"></ion-icon>
                            </li>
                            <li>
                                <ion-icon class="icon-small" name="checkmark"></ion-icon>Free delivery
                            </li>
            ...
            <div class="row">
                <form method="post" action="mailer-new.php" class="contact-form">
                    ...
                    <div class="row">
                        ...
                        <div class="col span-2-of-3">
                            <textarea name="message" placeholder="Your message" id="message" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col span-1-of-3">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-2">
                <ul class="social-links">
                    ...
                    <li>
                        <a href="#">
                            <ion-icon name="logo-googleplus" class="googleplus-icon"></ion-icon>
                        </a>
                    </li>
                </ul>
            </div>
